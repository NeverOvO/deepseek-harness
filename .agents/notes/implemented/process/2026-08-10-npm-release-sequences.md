...
| release-set boundary | every member of `packages/*/*` and `vendor/*`, plus `apps/cli` and `apps/web`; the exact private-native allowlist excludes `apps/desktop` |
